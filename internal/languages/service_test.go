...
type cacheStub struct {
	get func(context.Context, string) (UserLanguages, bool, error)
	set func(context.Context, string, UserLanguages, time.Duration) error
}
...
func TestServiceGetReturnsCachedLanguages(t *testing.T) {
	want := UserLanguages{
		Username: "mhmdnurf",
	...
	service, err := NewService(
		...
		cacheStub{
			get: func(
				...
				return UserLanguages{}, false, nil
			},
			set: func(
				_ context.Context,
				key string,
			...
			service, err := NewService(
				...
				cacheStub{
					get: func(
						...
						return UserLanguages{}, false, test.getError
					},
					set: func(
						context.Context,
						string,
	...
	service, err := NewService(
		...
		cacheStub{
			get: func(
				...
				return UserLanguages{}, false, wantError
			},
			set: func(
				context.Context,
				string,
